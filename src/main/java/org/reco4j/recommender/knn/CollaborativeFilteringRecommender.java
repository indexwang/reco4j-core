  ...
  extends BasicRecommender<ICollaborativeFilteringRecommenderConfig>
{
  ...
  {
    ConcurrentHashMap<Long, INode> nodesByInEdge = item.getCommonNodes(rankEdgeType, getConfig().getItemIdentifierName());
...
//    ISimilarity similarityFunction = SimilarityFactory.getSimilarityClass(similarityConfig);
  ...
  public void updateRecommender(IEdge newEdge, int operation)
  {
    ...
    ConcurrentHashMap<Long, INode> commonNodes = dest.getCommonNodes(rankEdgeType, getConfig().getItemIdentifierName());
